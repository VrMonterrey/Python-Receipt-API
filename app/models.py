...
class Product(Base):
    ...
    receipts = relationship('Receipt', secondary='receipt_product', back_populates='products')
...
class Receipt(Base):
    ...
    products = relationship('Product', secondary='receipt_product', back_populates='receipts')
